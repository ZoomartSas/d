...
INSERT INTO full_name (courses_id,faculry_id,gender_id,school_id,full_name) VALUES
    (1,1,2,5,'Лыкова Ольгп Петровна'),
    (2,2,1,1,'Семкнов Олег Еннвкендивич'),
    (2,1,2,2,'Гордилова Елена Юрьевна'),
    (1,4,2,1,'Захарова Иртна Петровна'),
    (1,2,1,3,'Родченко Андрей Иванович'),
    (2,1,1,4,'Горохов Олег Макарович'),
    (1,3,2,5,'Семенова Татьяна Евгеньевна'),
    (2,4,1,1,'Григорив Сергей Викторович'),
    (1,2,1,3,'Морозов Иван Иванович'),
    (2,3,2,1,'Шумлова Антонина Михалова'),
    (1,2,2,2,'Михайлова Анна Сергейевна'),
    (1,3,1,3,'Бобров Игорь Андреевич'),
    (2,4,1,5,'Рыбков Роман Петрович'),
    (1,3,1,1,'Горбунов Кирил Андреевич');
